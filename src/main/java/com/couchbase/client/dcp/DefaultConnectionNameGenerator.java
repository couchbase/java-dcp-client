...
public class DefaultConnectionNameGenerator implements ConnectionNameGenerator {
  ...
  /**
   * Returns the connection ID from the given connection name, or null if
   * the connection name was not generated by this connection name generator.
   */
