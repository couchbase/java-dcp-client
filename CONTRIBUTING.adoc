...
If you come across a bug or find something unintuitive, let us know.
We’ll work to fix it in an upcoming release.

To file a bug report or feature request, go to the https://github.com/couchbase/java-dcp-client/issues[GitHub Issues tab].
